...
const IBFight = ({ ReturnToSelection }) => {
    ...
    for(let i = 0; i < FIGHT_MAX_ROUNDS; i++) {
        ...
        rounds.push(
            <div className="d-flex justify-content-around">
                <label className="noStyleLabel" for={radioName + "_" + fightOptions.PUNCH}>
                ...
                <label className="noStyleLabel ml-1 mr-1" for={radioName + "_" + fightOptions.TACKLE}>
                ...
                <label className="noStyleLabel" for={radioName + "_" + fightOptions.KICK}>
        ...
        if(i < FIGHT_MAX_ROUNDS - 1)
            rounds.push(<hr className="bg-light mt-2 mb-2" />);
    }


    return (
        <div className="h-100 w-100 d-flex flex-column">
            <PageTitleBar BackFunc={ReturnToSelection} title='Fight' />
